...
public class HexedGenerator extends Generator{
    // 12 players: 310 - 310 , r = 90, s = 94

    //public static int size = 516;
    public static int radius = 74;
    public static int spacing = 78;
    ...
    */
    public HexedGenerator(int _sizew, int _sizeh){
        super(_sizew, _sizeh);
        //this.size = _size;
        this.width = _sizew;
        this.height = _sizeh;
    ...
    /*
    public HexedGenerator(int _sizew, int _sizeh, int _radius, int _spacing){
        super(_sizew, _sizeh);
        this.width = _sizew;
        this.height = _sizeh;
        this.radius = _radius;
